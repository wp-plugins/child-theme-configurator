...
<div id="file_options_panel" 
  ...
  <div class="ctc-input-row clearfix" id="input_row_theme_image">
    <form id="ctc_theme_image_form" method="post" action="?page=<?php echo CHLD_THM_CFG_MENU_NAME; ?>" enctype="multipart/form-data">
  ...
  <div class="ctc-input-row clearfix" id="input_row_screenshot">
    <form id="ctc_screenshot_form" method="post" action="?page=<?php echo CHLD_THM_CFG_MENU_NAME; ?>" enctype="multipart/form-data">
      <?php wp_nonce_field( 'ctc_update' ); ?>
      <div class="ctc-input-cell"> <strong>
  ...
  <div class="ctc-input-row clearfix" id="input_row_screenshot">
    <form id="ctc_export_form" method="post" action="?page=<?php echo CHLD_THM_CFG_MENU_NAME; ?>">
      <?php wp_nonce_field( 'ctc_update' ); ?>
      <div class="ctc-input-cell"> <strong>
  ...
  <div class="ctc-input-row clearfix" id="input_row_permissions">
    <form id="ctc_permission_form" method="post" action="?page=<?php echo CHLD_THM_CFG_MENU_NAME; ?>">
      <?php wp_nonce_field( 'ctc_update' ); ?>
      <div class="ctc-input-cell"> <strong>
