...
<p><?php _e( 'IntelliWidget is a versatile WordPress plugin that does the work of multiple plugins by combining custom page menus, featured posts, sliders and other content into a single widget that can display on a content driven or site-wide basis.', 'chld_thm_cfg' ); ?> <a href="<?php echo LILAEAMEDIA_URL; ?>/plugins/intelliwidget/" title="<?php _e( 'Learn more about IntelliWidget', 'chld_thm_cfg' ); ?>">
